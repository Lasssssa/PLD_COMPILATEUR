    ...
    switch (op) {
        ...
        case call:
            ...
            for (size_t i = 2; i < params.size(); i++) {
                if (i == 2) o << "\tmovl\t" << IR_reg_to_asm(params[i]) << ", %edi\n";
                else if (i == 3) o << "\tmovl\t" << IR_reg_to_asm(params[i]) << ", %esi\n";
                else if (i == 4) o << "\tmovl\t" << IR_reg_to_asm(params[i]) << ", %edx\n";
                else if (i == 5) o << "\tmovl\t" << IR_reg_to_asm(params[i]) << ", %ecx\n";
                else if (i == 6) o << "\tmovl\t" << IR_reg_to_asm(params[i]) << ", %r8d\n";
                else if (i == 7) o << "\tmovl\t" << IR_reg_to_asm(params[i]) << ", %r9d\n";
                else {
